    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div
        className={cn(
          ...
          !isLoginPage && (isCollapsed ? "lg:ml-[70px]" : "lg:ml-56")
        )}
      >
        {!isLoginPage && (
          <header className="sticky top-0 z-30 h-16 bg-background/80 backdrop-blur-md border-b border-border flex items-center justify-between px-4 sm:px-6">
            <div className="flex items-center gap-4">
              ...
              <div className="hidden sm:flex items-center relative">
                ...
                <Input
                  ...
                  className="w-64 lg:w-80 pl-9 h-10 bg-muted border-border"
                />
              </div>
            </div>
        ...
        <main className={cn(!isLoginPage && "p-4 sm:p-5 lg:p-6")}>{children}</main>
      </div>
    </div>
  )
}
