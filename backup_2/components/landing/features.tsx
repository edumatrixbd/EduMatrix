...
const features = [
  {
    ...
    description: "High-quality video explanations for every topic, designed specifically for DIU CSE curriculum.",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground text-balance">
            ...
            <span className="gradient-text">excel in your exams</span>
          </h2>
          <p className="mt-4 text-lg text-muted-foreground text-pretty">
            A complete ecosystem of study resources designed specifically for DIU CSE students
          </p>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-2xl blur-xl -z-10 from-primary/20 to-primary/5" />
              
              <div className="relative h-full p-6 sm:p-8 rounded-2xl border border-border bg-card hover:border-primary/30 transition-all duration-300 hover:shadow-premium">
                {/* Icon */}
